...
rule seurat_build_reference_kramann:
    ...
    output:
        ...
        umap_coarse = "reference/kramann/seurat_build_reference/umap_coarse.pdf",
        umap_fine = "reference/kramann/seurat_build_reference/umap_fine.pdf"
    params:
...
rule seurat_integrate_transfers:
    ...
    output:
        data_out = "results_groups/{group}/rna/seurat_integrate_transfers/{reference}.tsv"
    params:
        seed = config["seurat_seed"],
