...
ggsave(output_paths[["umap_kramann_fine"]], plt, device = "pdf", width = 12, height = 7)
...
ggsave(output_paths[["umap_ellinor_fine"]], plt, device = "pdf", width = 12, height = 7)
...
ggsave(output_paths[["umap_teichmann_fine"]], plt, device = "pdf", width = 12, height = 7)
...
ggsave(output_paths[["umap_azimuth_fine"]], plt, device = "pdf", width = 12, height = 7)
