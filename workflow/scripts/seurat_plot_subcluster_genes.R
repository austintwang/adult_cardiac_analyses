...
plt <- DoHeatmap(subset(proj, downsample = 100), features = genes[,2], size = 3)
ggsave(output_paths[["heatmap"]], plt, device = "pdf", width = 10, height = 5, limitsize = FALSE, raster = FALSE)